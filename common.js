...
{id:45,cat:'club',brand:'TaylorMade',name:'Qi10 11本セット（3wood/7iron/1putt）',img:'qi10_1',gallery:['qi10_1','qi10_2','qi10_3'],desc:'三菱ケミカル Diamana TM 60 シャフト搭載。3本wood, 6I〜PW，52，58のアイロンセット, 1本パター。',descLong:'TaylorMade Qi10アイアンの5I・6I・7I・8I・9I・PW・SWの7本セット、ドライバー、ユーティリティ、フェアウエーウッド、パター。シャフトには三菱ケミカル製「Diamana TM 60」（フレックスR）を採用し、しなやかな振り心地とコントロール性を両立します。',price:206000,badge:'NEW',icon:null,specs:[['セット構成','6I / 7I / 8I / 9I / PW / 52 / 58（7本）/ドライバー/ユーティリティ/フェアウエーウッド/パター'],['シャフト','三菱ケミカル Diamana TM 60'],['フレックス','R'],['状態','新品']],rating:0,reviews:[]},
];
