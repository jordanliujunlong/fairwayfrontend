...
{id:45,cat:'club',brand:'TaylorMade',name:'Qi10 Irons (6-P) 5本セット',img:'qi10_1',gallery:['qi10_1','qi10_2','qi10_3'],desc:'三菱ケミカル Diamana TM 60 シャフト搭載。6I〜PWの実用5本セット。',descLong:'TaylorMade Qi10アイアンの6I・7I・8I・9I・PWの5本セット。シャフトには三菱ケミカル製「Diamana TM 60」（フレックスR）を採用し、しなやかな振り心地とコントロール性を両立します。中古品のため、状態の詳細はお問い合わせください。',price:206000,badge:'NEW',icon:null,specs:[['セット構成','6I / 7I / 8I / 9I / PW（5本）'],['シャフト','三菱ケミカル Diamana TM 60'],['フレックス','R'],['状態','新品']],rating:0,reviews:[]},
];
